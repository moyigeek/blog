...
& ~
```
![rsyslog_conv](/images/posts/网安实践5-3-1/rsyslog_conv.png)
...
![rsyslog](/images/posts/网安实践5-3-1/remotlogserver.png)
...
```
出现按ip地址分类的日志
![nxlog](/images/posts/网安实践5-3-1/nxlog.png)
...
![process_monitor](/images/posts/网安实践5-3-1/pm.png)
1.3	状态栏显示每条字段的含义。
...
![systracer](/images/posts/网安实践5-3-1/shot.png)
